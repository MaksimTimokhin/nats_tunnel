...
function(protobuf_generate)
  ...
  foreach(_proto ${protobuf_generate_PROTOS})
    ...
    add_custom_command(
      ...
      ARGS --${protobuf_generate_LANGUAGE}_out ${_dll_export_decl}${protobuf_generate_PROTOC_OUT_DIR} --plugin=protoc-gen-rpc=${CMAKE_BINARY_DIR}/bin/protoc-gen-rpc --rpc_out  ${_dll_export_decl}${protobuf_generate_PROTOC_OUT_DIR} ${_dll_desc_out} ${_protobuf_include_path} ${_abs_file}
      DEPENDS ${_abs_file} protobuf::protoc protoc-gen-rpc
